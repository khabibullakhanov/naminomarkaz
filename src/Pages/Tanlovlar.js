    ...
    <div id="tanlovlar">
      ...
      <div id="yetakchi">
        <div id="tanl">
          ...
          <a href="https://yoshlarakademiyasi.uz/2022/04/18/innovatsion-g%ca%bboyalar-yetakchisi-maqomiga-ega-bo%ca%bblish-imkoniyatini-qo%ca%bbldan-boy-bermang-2/" target="_blank" rel="noopener noreferrer"><button>Batafsil &#8594; </button></a>
        </div>
        ...
        <div id="tanl">
          ...
          <a target="_blank" rel="noopener noreferrer" href="https://yoshlarakademiyasi.uz/2022/04/12/yoshlar-akademiyasi-bo%ca%bblajak-olim-tanlovi-3-mavsumini-e%ca%bclon-qiladi/"> <button>Batafsil &#8594; </button></a>
        </div>
        ...
        <div id="tanl">
          ...
          <a target="_blank" rel="noopener noreferrer" href="http://https://yoshlarakademiyasi.uz/2022/05/05/bo%ca%bblajak-olim-tanlovi-doirasida-ayollar-biznesi-uchun-birinchi-qadam-tanlovi-e%ca%bclon-qilinadi/"> <button>Batafsil &#8594; </button></a>
        </div>
      </div>
      <Futr />
    </div >
